            ...
            return _this2.state.colors[color] && _this2.state.colors[color].indexOf('#') > -1 ? React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement('img', { className: 'Img', src: "//prod2.atgcdn.ae/small_light(cw=70,ch=70,dw=70,dh=70,of=webp,q=90)/media/attribute/swatch" + _this2.state.colors[color], alt: color })
                )
              )
            );
          })
